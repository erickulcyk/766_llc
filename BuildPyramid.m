function [ pyramid_all ] = BuildPyramid( imageFileList, imageBaseDir, dataBaseDir, dictBaseDir, params, canSkip, canSkipSift, saveSift  )
%function [ pyramid_all ] = BuildPyramid( imageFileList, imageBaseDir, dataBaseDir, params, canSki )
%
...
CalculateDictionary(imageFileList,imageBaseDir,dataBaseDir, dictBaseDir, '_sift.mat',params,canSkip,pfig);
BuildHistograms(imageFileList,imageBaseDir,dataBaseDir,dictBaseDir, '_sift.mat',params,1,pfig);
pyramid_all = CompilePyramid(imageFileList,dataBaseDir,sprintf('_texton_ind_%d.mat',params.dictionarySize),params,1,pfig);
close(pfig);
end
